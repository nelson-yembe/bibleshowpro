...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::list_theme_versions,
            commands::restore_theme_version,
            commands::list_theme_assets,
            commands::add_theme_asset,
            commands::delete_theme_asset,
            commands::list_media,
            commands::add_media,
            commands::import_media_files,
            commands::read_media_data_url,
            commands::ensure_video_thumbnail,
            commands::backfill_video_thumbnails,
            commands::save_media_thumbnail_jpeg,
